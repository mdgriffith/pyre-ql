...
Documentation for using, developing, and understanding Pyre.

## Contents

- [Architecture](./architecture.md) - High-level engine, generation, and sync flow map
...
- [`pyre serve` Spec](./spec/pyre-serve.md) - Built-in single-database server command
